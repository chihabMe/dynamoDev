          ...
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center">
              <Link href="/" className="flex-shrink-0">
                <span className="text-teal-400 text-2xl font-bold tracking-tight">DevAgency</span>
              </Link>
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  ...
                  <Link href="#" className="text-gray-300 hover:bg-slate-700 hover:text-teal-400 px-3 py-2 rounded-md text-sm font-medium transition duration-150 ease-in-out">Portfolio</Link>
                  <Link href="#" className="text-gray-300 hover:bg-slate-700 hover:text-teal-400 px-3 py-2 rounded-md text-sm font-medium transition duration-150 ease-in-out">About</Link>
