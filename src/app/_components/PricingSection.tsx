    ...
    >
      <div className="container px-4 mx-auto">
        ...
        >
          ...
          >
            <div className={ `flex flex-col p-6 space-y-6 rounded-lg shadow-lg sm:p-8 ${plan.best?"bg-gradient-to-br from-teal-400 to-teal-600 text-gray-900":"text-white"} w-full transform scale-105 transition-transform duration-300 ease-in-out hover:scale-110` }>
